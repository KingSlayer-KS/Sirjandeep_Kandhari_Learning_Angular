...
export class InMemoryDataService implements InMemoryDbService {
  createDb():{products:Item[]} {
    const products: Item[] = [
      ...
      { id: 4, name: 'ipad', description: 'tablet apple', price: 250, inStock: true, category: 'Furniture',img:"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.6fm16TJHg06NiF9y6TInowHaHa%26pid%3DApi&f=1&ipt=87f838b184a79f76d6a7d96546c48b4fd0e9b480f770dc00f722eda171ea8a27&ipo=images",  },
